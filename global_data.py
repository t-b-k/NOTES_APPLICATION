...
COMMANDS_LIST = "\n".join(["{:56}{}".format("        m - Просмотреть список доступных команд", "l - Просмотреть все заметки"),
                          "{:56}{}".format("        a - Добавить новую заметку", "f - Найти и просмотреть заметку"),
                          "{:56}{}".format("        e - Редактировать заметку", "d - Удалить заметку"),
                          "{:56}{}".format("        w - Записать изменения в исходный файл базы данных", 
                                           "s - Сохранить изменения в новый файл .csv"),
                          "{:56}\n".format("        q - Выйти (без сохранения изменений)")])
